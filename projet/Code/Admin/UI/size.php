          ...
          <div class="row">
            <div class="col-md-6">
              <div class="card">
                ...
                <form method="post" action="../Controller/size.php">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      <input type="submit" value="ADD" name="sizeadd" class="btn back">
                    </div>
                  </div>
                </form>
              </div>
            ...
            <div class="col-md-6">
              <div class="card">
                                      ...
                                      <div class="card">
                                        ...
                                        <form method="post" action="../Controller/size.php">
                                          <div class="card-body">
                                            <div class="form-group">
                                              <label for="name">Name</label>
                                              <input type="hidden" class="form-control" value="<?= $size->getId() ?>" name="sizeid">
                                              <input type="text" class="form-control" value="<?= $size->getName() ?>" name="sizename" placeholder="Enter Name">
                                            </div>
                                            <div class="form-group">
                                              <input type="submit" value="Edit" name="sizeEdit" class="btn back">
                                            </div>
                                          </div>
                                        </form>
                                      </div>
                ...
                <div class="col-md-3">
                  <a href="../Controller/size.php?iddelete=<?= $size->getId() ?>" class="btn"><i class="fas fa-trash"></i></a>
                </div>
                </td>
